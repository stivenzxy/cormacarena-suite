...
@Component
public class GuardarLicenciaOtorgada implements JavaDelegate {

    private final SolicitudService solicitudService;
    private static final Logger logger = LoggerFactory.getLogger(GuardarLicenciaOtorgada.class);

    public GuardarLicenciaOtorgada(SolicitudService solicitudService) {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        if (idSolicitud != null && !idSolicitud.isBlank()) {
            solicitudService.actualizarEstado(idSolicitud, "Licencia Otorgada");
        } else {
